...
| 3 | [`3-js.html`](tilda/3-js.html) | 110 КБ | приложение: рисует разметку и оживляет её |
...
- [`all-in-one.html`](tilda/all-in-one.html) — всё сразу, 145 КБ;
...
- всё на выходе минифицировано esbuild: без комментариев и пустых строк, кириллица не экранируется. CSS 34 КБ, JS 110 КБ.
